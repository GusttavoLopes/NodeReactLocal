...
const generateToken = asyncuser => jwt.sign(user, process.env.JWT_SECRET);
// verifica se o token é válido
const validateToken = asynctoken => {
    return jwt.verify(token, process.env.JWT_SECRET, (err, decoded) => {
        if (err) throw newError("Problema para checar os dados de acesso");
        else return decoded;
    });
};
...
module.exports = { authMiddleware, getToken, generateToken };